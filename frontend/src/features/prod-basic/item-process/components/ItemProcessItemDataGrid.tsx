...
interface ItemProcessItemDataGridProps {
  items: ItemResponse[]
  loading: boolean
...
const ItemProcessItemDataGrid = ({
  items,
  loading,
  selectedItemId,
  onSelectItem,
}: ItemProcessItemDataGridProps) => {
  ...
  return (
    <AppDataGrid<ItemResponse>
      ...
      getRowClassName={(params) =>
        params.row.id === selectedItemId ? 'selected-item-process-item' : ''
      }
      ...
      sx={{
        ...
        '& .MuiDataGrid-row.selected-item-process-item': {
...
export default ItemProcessItemDataGrid

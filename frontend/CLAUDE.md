# Frontend CLAUDE.md (허브)

프론트엔드 개발 규칙은 아래 문서로 분리되어 있습니다.
상황에 맞는 문서를 참조하세요.
...
| 상황 | 참조 문서 |
|---|---|
| 새 파일/폴더를 어디에 만들지 판단할 때 | [docs/folder-structure.md](docs/folder-structure.md) |
...
| 스타일링 (MUI 1순위, Tailwind 보조, cn() 유틸, 전역 CSS) 작업 시 | [docs/styling.md](docs/styling.md) |
| 주석 작성 기준이 필요할 때 | [docs/comments.md](docs/comments.md) |
| 라우트 추가 또는 인증 가드 수정 시 | [docs/routing.md](docs/routing.md) |
| 타입 정의 위치, any 금지, as const 패턴 등 TS 작업 시 | [docs/typescript.md](docs/typescript.md) |
| 디자인 토큰, 색상, 타이포그래피 확인 시 | [DESIGN_SYSTEM.md](DESIGN_SYSTEM.md) |
